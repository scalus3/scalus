Source: https://scalus.org/docs/language-guide
...
**Supported**: Functions, pattern matching, case classes, enums, higher-order functions, recursion (including mutual recursion of top-level `def`s), `given`/`using`, inline macros
...
3. [Your First Smart Contract](/docs/smart-contracts/developing-smart-contracts) - Write your first validator
