Source: https://scalus.org/docs/smart-contracts/parameterized-validators
...
object TimeLock:
    inline def validate(deadline: PosixTime)(datum: Option[Data], redeemer: Data, tx: TxInfo, outRef: TxOutRef): Unit =
        require(tx.validRange.isEntirelyAfter(deadline), "Too early")
        // ... rest of validation
...
object Vesting:
    inline def validate(beneficiary: PubKeyHash, unlockTime: PosixTime)(
        ...
        require(tx.validRange.isEntirelyAfter(unlockTime), "Still locked")
