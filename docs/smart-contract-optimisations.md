...
given Options = Options(
  ...
  optimizeUplc = true,
  valueBuiltins = true // default: lower Value ops to CIP-153 builtins at PV11
)
```
...
- **[Equality and Lookups](/docs/smart-contract-optimisations/equality-and-lookups)** -- measured costs of `hasInlineDatum`, `===`, `contains`, `count`, `findUniqueOrFail`, `SortedMap`
- **[Profiling](/docs/smart-contract-optimisations/profiling)** -- CEK machine budget profiling, per-line costs, machine-readable reports
- **[VS Code Extension](/docs/smart-contract-optimisations/vscode-extension)** -- inline cost annotations and the compiled UPLC view in your editor
...
- **[Value Builtins](/docs/smart-contract-optimisations/value-builtins)** -- prelude `Value` operations lowered to CIP-153 builtins at PV11
