Source: https://scalus.org/docs/testing/tdd-atdd-workflow
...
Once the happy path works, use [Boundary Testing](/docs/testing/boundary-testing) to automatically explore edge cases and attack vectors:
...
The boundary testing toolkit generates steal attempts, corrupted datums, double satisfaction attacks, and boundary value variations — all derived from your contract's structure.
...
│     Boundary testing explores edge cases          │
...
- [Boundary Testing](/docs/testing/boundary-testing) — automated edge case and attack exploration
