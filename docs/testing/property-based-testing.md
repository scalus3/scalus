Source: https://scalus.org/docs/testing/property-based-testing
...
Both use the same `ContractStepVariations` interface and can be combined with [attack patterns](/docs/testing/boundary-testing#standard-variations) for security testing.

See [Boundary Testing](/docs/testing/boundary-testing) for the full guide on multi-step testing, transaction variations, and attack simulation.
...
- [Boundary Testing](/docs/testing/boundary-testing) — Multi-step testing, attack patterns, and state-space exploration
