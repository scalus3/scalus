Source: https://scalus.org/docs/design-patterns/linked-list
...
object MyListValidator extends DataParameterizedValidator {
    ...
    // policyId is the minting script's own hash, handed in by the Validator trait
    inline override def mint(cfgData: Data, redeemer: Data, policyId: PolicyId, tx: TxInfo): Unit = {
