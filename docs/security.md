Source: https://scalus.org/docs/security
...
- [Datum Shape Validation](/docs/security/datum-validation) - Why decoding is lazy by default and when to validate datum shapes
- [Boundary Testing](/docs/testing/boundary-testing) - Boundary testing and attack simulation for smart contracts
