Source: https://scalus.org/docs/smart-contract-optimisations/lowering-backends
...
The `Options.default`, `Options.debug`, `Options.release`, and `Options.plomin` presets all use V3 Lowering. To switch to a different backend, build `Options` directly with the `targetLoweringBackend` you want.
