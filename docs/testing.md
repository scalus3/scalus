...
| **[Profiling](/docs/smart-contract-optimisations/profiling)** | CEK machine budget profiling | Finding expensive code paths |
...
- [Profiling](/docs/smart-contract-optimisations/profiling) — CEK machine budget profiling
