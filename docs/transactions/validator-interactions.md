Source: https://scalus.org/docs/transactions/validator-interactions
...
```scala copy
import scalus.uplc.builtin.{ByteString, ToData}
...
TxBuilder(env, evaluator)
  ...
  // ... rest of transaction
  .build(changeTo = changeAddress)  // Validator is evaluated here
```
...
- **[Advanced Features](/docs/transactions/advanced-features)** - Learn about `complete()`, reference scripts, and more
- **[Smart Contract Examples](https://github.com/scalus3/scalus/tree/master/scalus-examples)** - More validator examples
