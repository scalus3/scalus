...
class Cip1852Test extends AnyFunSuite {
    ...
    test("path with role") {
        assert(Cip1852.path(0, Cip1852.RoleExternal, 0) == "m/1852'/1815'/0'/0/0")
        assert(Cip1852.path(0, Cip1852.RoleInternal, 0) == "m/1852'/1815'/0'/1/0")
        assert(Cip1852.path(0, Cip1852.RoleStaking, 0) == "m/1852'/1815'/0'/2/0")
        assert(Cip1852.path(0, Cip1852.RoleDRep, 0) == "m/1852'/1815'/0'/3/0")
    }

    test("parsePath - valid paths") {
        val result1 = Cip1852.parsePath("m/1852'/1815'/0'/0/0")
        assert(result1 == Some((0, Cip1852.RoleExternal, 0)))

        val result2 = Cip1852.parsePath("m/1852'/1815'/0'/1/5")
        assert(result2 == Some((0, Cip1852.RoleInternal, 5)))

        val result3 = Cip1852.parsePath("m/1852'/1815'/2'/2/0")
        assert(result3 == Some((2, Cip1852.RoleStaking, 0)))

        val result4 = Cip1852.parsePath("m/1852'/1815'/0'/3/0")
        assert(result4 == Some((0, Cip1852.RoleDRep, 0)))
    }
