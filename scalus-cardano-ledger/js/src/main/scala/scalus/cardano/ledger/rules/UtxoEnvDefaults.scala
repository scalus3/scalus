...
/** JS implementation - uses embedded protocol parameters JSON string.
  *
  * JavaScript cannot use getResourceAsStream, so we embed the JSON directly.
  */
private[rules] object UtxoEnvDefaults {

    @threadUnsafe lazy val default: UtxoEnv = {
        val params: ProtocolParams = ProtocolParams.fromBlockfrostJson(protocolParamsJson)
    ...
    // Epoch 544 mainnet protocol parameters in Blockfrost JSON format
    private val protocolParamsJson: String =
        """
{
  "epoch": 544,
  "min_fee_a": 44,
  ...
  "nonce": "3e9d130431ae4951c31ce812a7faa948dd73e85128c18ddde419e9a94e5cc170",
  "cost_models": {
    "PlutusV1": {
