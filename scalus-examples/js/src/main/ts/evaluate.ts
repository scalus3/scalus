...
console.log(evalPlutusScripts(txBytes, utxoBytes, slotConfig, costModels));
...
try {
    const failingRedeemers = evalPlutusScripts(failingTx, failingUtxo, slotConfig, costModels);
} catch (error) {
