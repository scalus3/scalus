...
/** Off-chain transaction builders for the lottery contract.
  *
  * Each method constructs, balances, and signs a complete transaction using TxBuilder.
  */
case class LotteryTransactions(
    ...
    /** Player one reveals their preimage, transitioning to PlayerOneRevealed. */
    def revealPlayerOne(
        utxos: Utxos,
        lotteryUtxo: Utxo,
        preimage: Preimage,
    ...
    /** Player two reveals their preimage, transitioning to PlayerTwoRevealed. */
    def revealPlayerTwo(
        utxos: Utxos,
        lotteryUtxo: Utxo,
        preimage: Preimage,
    ...
    /** Non-revealing player claims pot after deadline when opponent failed to reveal. */
    def timeout(
        utxos: Utxos,
        lotteryUtxo: Utxo,
        preimage: Preimage,
