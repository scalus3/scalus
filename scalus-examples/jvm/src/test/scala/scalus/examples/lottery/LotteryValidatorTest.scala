...
class LotteryValidatorTest extends AnyFunSuite, ScalusTest {
    ...
    test("P1 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 56921, steps = 24_888_156)
        )
    }
    ...
    test("P2 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 56921, steps = 24_842_980)
        )
    }
    ...
    test("P2 reveals with even sum (32 + 16 = 48)") {
        ...
        assertSuccess(
          ...
          p2RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 40963, steps = 16_786_217)
        )
    }
    ...
    test("P2 timeout after P2 revealed but P1 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 45235, steps = 18_372_131)
        )
    }
    ...
    test("P2 concedes after P1 revealed - P1 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 42073, steps = 18_306_644)
        )
    }
    ...
    test("P1 timeout after P1 revealed but P2 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 45003, steps = 18_303_644)
        )
    }
    ...
    test("P1 concedes after P2 revealed - P2 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 41841, steps = 18_238_157)
        )
    }
    ...
    test("P1 reveals with even sum (32 + 16 = 48) after P2 revealed") {
        ...
        assertSuccess(
          ...
          p1RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 40731, steps = 16_717_730)
        )
    }
}
