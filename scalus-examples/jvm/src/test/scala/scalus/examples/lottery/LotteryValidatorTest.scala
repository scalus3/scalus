...
class LotteryValidatorTest extends AnyFunSuite, ScalusTest {
    ...
    test("P1 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 67653, steps = 26_921150)
        )
    }
    ...
    test("P2 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 67885, steps = 26_989637)
        )
    }
    ...
    test("P2 reveals with even sum (32 + 16 = 48)") {
        ...
        assertSuccess(
          ...
          p2RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 47331, steps = 18_018134)
        )
    }
    ...
    test("P2 timeout after P2 revealed but P1 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 51235, steps = 19_332131)
        )
    }
    ...
    test("P2 concedes after P1 revealed - P1 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 49181, steps = 19_693679)
        )
    }
    ...
    test("P1 timeout after P1 revealed but P2 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 51003, steps = 19_263644)
        )
    }
    ...
    test("P1 concedes after P2 revealed - P2 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 48949, steps = 19_625192)
        )
    }
    ...
    test("P1 reveals with even sum (32 + 16 = 48) after P2 revealed") {
        ...
        assertSuccess(
          ...
          p1RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 47099, steps = 17_949647)
        )
    }
}
