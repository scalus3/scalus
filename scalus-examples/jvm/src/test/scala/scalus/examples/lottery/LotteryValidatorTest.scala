...
class LotteryValidatorTest extends AnyFunSuite, ScalusTest {
    ...
    test("P1 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 202556, steps = 62_204804)
        )
    }
    ...
    test("P2 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 204122, steps = 62_751568)
        )
    }
    ...
    test("P2 reveals with even sum (32 + 16 = 48)") {
        ...
        assertSuccess(
          ...
          p2RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 117104, steps = 34_993715)
        )
    }
    ...
    test("P2 timeout after P2 revealed but P1 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 120435, steps = 37_288065)
        )
    }
    ...
    test("P2 concedes after P1 revealed - P1 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 186957, steps = 55_177430)
        )
    }
    ...
    test("P1 timeout after P1 revealed but P2 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 120203, steps = 37_219578)
        )
    }
    ...
    test("P1 concedes after P2 revealed - P2 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 186725, steps = 55_108943)
        )
    }
    ...
    test("P1 reveals with even sum (32 + 16 = 48) after P2 revealed") {
        ...
        assertSuccess(
          ...
          p1RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 115538, steps = 34_446951)
        )
    }
}
