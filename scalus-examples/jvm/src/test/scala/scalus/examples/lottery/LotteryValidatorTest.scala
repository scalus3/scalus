...
class LotteryValidatorTest extends AnyFunSuite, ScalusTest {
    ...
    test("P1 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 59077, steps = 25_554_167)
        )
    }
    ...
    test("P2 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 58913, steps = 25_389_699)
        )
    }
    ...
    test("P2 reveals with even sum (32 + 16 = 48)") {
        ...
        assertSuccess(
          ...
          p2RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 42955, steps = 17_332_936)
        )
    }
    ...
    test("P2 timeout after P2 revealed but P1 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 46531, steps = 18_694_970)
        )
    }
    ...
    test("P2 concedes after P1 revealed - P1 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 43901, steps = 18_734_071)
        )
    }
    ...
    test("P1 timeout after P1 revealed but P2 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 46299, steps = 18_626_483)
        )
    }
    ...
    test("P1 concedes after P2 revealed - P2 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 43669, steps = 18_665_584)
        )
    }
    ...
    test("P1 reveals with even sum (32 + 16 = 48) after P2 revealed") {
        ...
        assertSuccess(
          ...
          p1RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 42723, steps = 17_264_449)
        )
    }
}
