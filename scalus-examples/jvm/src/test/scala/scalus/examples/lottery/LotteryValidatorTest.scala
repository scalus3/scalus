...
class LotteryValidatorTest extends AnyFunSuite, ScalusTest {
    ...
    test("P1 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 67953, steps = 26_969150)
        )
    }
    ...
    test("P2 reveals valid preimage from Empty state") {
        ...
        assertSuccess(
          ...
          revealTx,
          lotteryUtxo._1,
          ExUnits(memory = 68185, steps = 27_037637)
        )
    }
    ...
    test("P2 reveals with even sum (32 + 16 = 48)") {
        ...
        assertSuccess(
          ...
          p2RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 47631, steps = 18_066134)
        )
    }
    ...
    test("P2 timeout after P2 revealed but P1 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 51535, steps = 19_380131)
        )
    }
    ...
    test("P2 concedes after P1 revealed - P1 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 49481, steps = 19_741679)
        )
    }
    ...
    test("P1 timeout after P1 revealed but P2 didn't reveal") {
        ...
        assertSuccess(
          ...
          timeoutTx,
          lotteryUtxo2._1,
          ExUnits(memory = 51303, steps = 19_311644)
        )
    }
    ...
    test("P1 concedes after P2 revealed - P2 gets pot") {
        ...
        assertSuccess(
          ...
          loseTx,
          lotteryUtxo2._1,
          ExUnits(memory = 49249, steps = 19_673192)
        )
    }
    ...
    test("P1 reveals with even sum (32 + 16 = 48) after P2 revealed") {
        ...
        assertSuccess(
          ...
          p1RevealTx,
          lotteryUtxo2._1,
          ExUnits(memory = 47399, steps = 17_997647)
        )
    }
}
