...
class AuctionValidatorTest extends AnyFunSuite, ScalusTest {
    ...
    test("budget: first bid") {
        ...
        assert(budget == ExUnits(memory = 299243, steps = 92_477519))
    }
    ...
    test("budget: outbid with refund") {
        ...
        assert(budget == ExUnits(memory = 392454, steps = 119_566592))
    }
    ...
    test("budget: end auction with winner") {
        ...
        assert(budget == ExUnits(memory = 419611, steps = 126_283221))
    }
    ...
    test("budget: end auction without bids") {
        ...
        assert(budget == ExUnits(memory = 322973, steps = 98_298880))
    }
}
