...
class SetBenchEmulatorTest extends AnyFunSuite with ScalusTest {
    ...
    private def benchAccWithdraw(n: Int): Unit = {
        val variant = "Acc (G1)"
        val contract = AccContract.compiled
    ...
    test("MPF-16o withdraw N=32K", Benchmark) {
        ...
        benchMpfWithdraw("MPF-16o", 32000, Mpf16oContract.compiled, MpfTrie.wrap16o)
    }

    test("MPF-16b withdraw N=32K", Benchmark) {
        info("=== MPF-16b withdraw N=32000 ===")
        benchMpfWithdraw("MPF-16b", 32000, Mpf16bContract.compiled, MpfTrie.wrap16b)
    }
    ...
    test("MPF-16o deposit N=32K", Benchmark) {
        ...
        benchMpfDeposit("MPF-16o", 32000, Mpf16oContract.compiled, MpfTrie.wrap16o)
    }

    test("MPF-16b deposit N=32K", Benchmark) {
        info("=== MPF-16b deposit N=32000 ===")
        benchMpfDeposit("MPF-16b", 32000, Mpf16bContract.compiled, MpfTrie.wrap16b)
    }
    ...
    test("MPF-16o withdraw N=100K", Benchmark) {
        ...
        benchMpfWithdraw("MPF-16o", 100000, Mpf16oContract.compiled, MpfTrie.wrap16o)
    }

    test("MPF-16b withdraw N=100K", Benchmark) {
        info("=== MPF-16b withdraw N=100000 ===")
        benchMpfWithdraw("MPF-16b", 100000, Mpf16bContract.compiled, MpfTrie.wrap16b)
    }

    test("MPF-16o deposit N=100K", Benchmark) {
        info("=== MPF-16o deposit N=100000 ===")
        benchMpfDeposit("MPF-16o", 100000, Mpf16oContract.compiled, MpfTrie.wrap16o)
    }

    test("MPF-16b deposit N=100K", Benchmark) {
        info("=== MPF-16b deposit N=100000 ===")
        benchMpfDeposit("MPF-16b", 100000, Mpf16bContract.compiled, MpfTrie.wrap16b)
    }
    ...
    test("MPF-16o withdraw N=1M", Benchmark) {
        ...
        benchMpfWithdraw("MPF-16o", 1000000, Mpf16oContract.compiled, MpfTrie.wrap16o)
    }

    test("MPF-16b withdraw N=1M", Benchmark) {
        info("=== MPF-16b withdraw N=1000000 ===")
        benchMpfWithdraw("MPF-16b", 1000000, Mpf16bContract.compiled, MpfTrie.wrap16b)
    }

    test("MPF-16o deposit N=1M", Benchmark) {
        info("=== MPF-16o deposit N=1000000 ===")
        benchMpfDeposit("MPF-16o", 1000000, Mpf16oContract.compiled, MpfTrie.wrap16o)
    }

    test("MPF-16b deposit N=1M", Benchmark) {
        info("=== MPF-16b deposit N=1000000 ===")
        benchMpfDeposit("MPF-16b", 1000000, Mpf16bContract.compiled, MpfTrie.wrap16b)
    }
