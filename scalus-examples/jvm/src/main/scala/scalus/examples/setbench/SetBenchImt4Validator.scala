...
@Compile
object SetBenchImt4Validator extends Validator {
    inline override def spend(
        ...
        import scalus.cardano.onchain.plutus.imt4.IncrementalMerkleTree4
        ...
        val (newRoot, newSize, delta) = action match
            case ImtRedeemer.Add(key, proofData) =>
                ...
                val nr = IncrementalMerkleTree4.append(
                  state.root,
                  state.size,
                  state.depth,
                  key,
            ...
            case ImtRedeemer.Deposit(key, proofData) =>
                ...
                IncrementalMerkleTree4.verifyMember(
                  state.root,
                  key,
                  slot,
                  state.depth,
