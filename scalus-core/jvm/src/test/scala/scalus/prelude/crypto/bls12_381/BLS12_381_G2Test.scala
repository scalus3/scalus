...
import scalus.uplc.builtin.PlatformSpecific.{bls12_381_G2_compressed_generator, bls12_381_G2_compressed_zero}
import scalus.uplc.builtin.{Builtins, ByteString}
import scalus.cardano.onchain.plutus.prelude.*
import scalus.cardano.onchain.plutus.prelude.crypto.bls12_381.G2.{*, given}
import scalus.testing.kit.EvalTestKit

class BLS12_381_G2Test extends AnyFunSuite with EvalTestKit {
