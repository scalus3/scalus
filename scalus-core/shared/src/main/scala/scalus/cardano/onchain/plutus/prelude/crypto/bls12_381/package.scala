...
package object bls12_381 {
    ...
    val G1 = scalus.cardano.onchain.plutus.prelude.bls12_381.G1

    @deprecated(s"Use $pkg.G2 instead", version)
    val G2 = scalus.cardano.onchain.plutus.prelude.bls12_381.G2

    @deprecated(s"Use $pkg.Scalar instead", version)
    val Scalar = scalus.cardano.onchain.plutus.prelude.bls12_381.Scalar

    @deprecated(s"Use $pkg.Scalar instead", version)
    type Scalar = scalus.cardano.onchain.plutus.prelude.bls12_381.Scalar
}
