...
abstract class PlutusConformanceTest extends AnyFunSuite:
    ...
    check("builtin/semantics/bls12_381_G1_multiScalarMul/multiScalarMul-13a/multiScalarMul-13a")
    check("builtin/semantics/bls12_381_G1_multiScalarMul/multiScalarMul-13b/multiScalarMul-13b")
    check("builtin/semantics/bls12_381_G1_multiScalarMul/multiScalarMul-13c/multiScalarMul-13c")
    check("builtin/semantics/bls12_381_G1_multiScalarMul/multiScalarMul-13d/multiScalarMul-13d")
    ...
    check("builtin/semantics/bls12_381_G2_multiScalarMul/multiScalarMul-13a/multiScalarMul-13a")
    check("builtin/semantics/bls12_381_G2_multiScalarMul/multiScalarMul-13b/multiScalarMul-13b")
    check("builtin/semantics/bls12_381_G2_multiScalarMul/multiScalarMul-13c/multiScalarMul-13c")
    check("builtin/semantics/bls12_381_G2_multiScalarMul/multiScalarMul-13d/multiScalarMul-13d")
    ...
    // --- Value builtins (van Rossem, added to the 1.63 corpus) ---
    // valueData (value -> Data) matches the reference.
    check("builtin/semantics/valueData/empty/empty")
    check("builtin/semantics/valueData/multi-currency/multi-currency")
    check("builtin/semantics/valueData/multi-token/multi-token")
    check("builtin/semantics/valueData/negative-quantity/negative-quantity")
    check("builtin/semantics/valueData/single-entry/single-entry")
    // unValueData correctly fails on malformed/out-of-range Data, matching the reference.
    check("builtin/semantics/unValueData/currency-key-too-long/currency-key-too-long")
    check("builtin/semantics/unValueData/non-bytestring-currency/non-bytestring-currency")
    check("builtin/semantics/unValueData/non-bytestring-token/non-bytestring-token")
    check("builtin/semantics/unValueData/non-integer-quantity/non-integer-quantity")
    check("builtin/semantics/unValueData/non-map-bytes/non-map-bytes")
    check("builtin/semantics/unValueData/non-map-constr/non-map-constr")
    check("builtin/semantics/unValueData/non-map-integer/non-map-integer")
    check("builtin/semantics/unValueData/non-map-list/non-map-list")
    check("builtin/semantics/unValueData/non-map-tokens/non-map-tokens")
    check("builtin/semantics/unValueData/quantity-overflow/quantity-overflow")
    check("builtin/semantics/unValueData/quantity-underflow/quantity-underflow")
    check("builtin/semantics/unValueData/token-key-too-long/token-key-too-long")
    // unValueData on valid Values (costed by Data node count, matching Plutus DataNodeCount).
    check("builtin/semantics/unValueData/data-duplicate-currencies/data-duplicate-currencies")
    check(
      "builtin/semantics/unValueData/data-duplicate-currencies-cancel/data-duplicate-currencies-cancel"
    )
    check(
      "builtin/semantics/unValueData/data-duplicate-currencies-merge/data-duplicate-currencies-merge"
    )
    check("builtin/semantics/unValueData/data-duplicate-tokens/data-duplicate-tokens")
    check("builtin/semantics/unValueData/data-empty-tokens/data-empty-tokens")
    check("builtin/semantics/unValueData/data-unordered-currencies/data-unordered-currencies")
    check("builtin/semantics/unValueData/data-unordered-tokens/data-unordered-tokens")
    check("builtin/semantics/unValueData/data-zero-quantity/data-zero-quantity")
    check("builtin/semantics/unValueData/data-zero-sum/data-zero-sum")
    check("builtin/semantics/unValueData/empty/empty")
    check("builtin/semantics/unValueData/max-key-len/max-key-len")
    check("builtin/semantics/unValueData/multi-currency/multi-currency")
    check("builtin/semantics/unValueData/multi-token/multi-token")
    check("builtin/semantics/unValueData/negative-quantity/negative-quantity")
    check("builtin/semantics/unValueData/roundtrip-from-data/roundtrip-from-data")
    check("builtin/semantics/unValueData/single-entry/single-entry")
    check("builtin/semantics/valueData/roundtrip-from-value/roundtrip-from-value")
