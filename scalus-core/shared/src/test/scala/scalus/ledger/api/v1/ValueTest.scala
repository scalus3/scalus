...
class ValueTest extends AnyFunSuite with EvalTestKit with ArbitraryInstances {
    ...
    test("+ token + token") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 104699L, steps = 28964010L)
        )
    }
    ...
    test("+ lovelace + lovelace") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          Value.lovelace(3000),
          ExUnits(memory = 104699L, steps = 28963898L)
        )
    }
    ...
    test("+ token + lovelace") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 138204L, steps = 37958627L)
        )
    }
    ...
    test("+ token cancel") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value.zero,
          ExUnits(memory = 81895L, steps = 22197324L)
        )
    }
    ...
    test("+ lovelace cancel") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          Value.zero,
          ExUnits(memory = 81895L, steps = 22197212L)
        )
    }
    ...
    test("+ multi-asset cancel") {
        assertEvalWithBudget(
          ...
          Value.zero,
          ExUnits(memory = 281548L, steps = 77870211L)
        )
    }
    ...
    test("+ multi-asset partial cancel token") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          ExUnits(memory = 214004L, steps = 58713123L)
        )
    }
    ...
    test("+ multi-asset partial cancel lovelace") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          ExUnits(memory = 208808L, steps = 57199645L)
        )
    }
