...
class ValueTest extends AnyFunSuite with EvalTestKit with ArbitraryInstances {
    ...
    test("fromStrictlyAscendingListWithNonZeroAmounts two policies") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 68611, steps = 16_710321)
        )
    }
    ...
    test("unary_ token") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value(utf8"PolicyId", utf8"TokenName", -1000),
          ExUnits(memory = 16642, steps = 3_820279)
        )
    }
    ...
    test("+ token + token") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 67591, steps = 16_079119)
        )
    }
    ...
    test("+ token + zero") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          ExUnits(memory = 52946, steps = 12_213367)
        )
    }
    ...
    test("+ zero + token") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          ExUnits(memory = 52146, steps = 12_085367)
        )
    }
    ...
    test("+ lovelace + lovelace") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          Value.lovelace(3000),
          ExUnits(memory = 67591, steps = 16_078970)
        )
    }
    ...
    test("+ token + lovelace") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 94830, steps = 22_834940)
        )
    }
    ...
    test("+ token cancel") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value.zero,
          ExUnits(memory = 49907, steps = 11_106848)
        )
    }
    ...
    test("+ lovelace cancel") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          Value.zero,
          ExUnits(memory = 49907, steps = 11_106699)
        )
    }
    ...
    test("+ multi-asset cancel") {
        assertEvalWithBudget(
          ...
          Value.zero,
          ExUnits(memory = 197441, steps = 47_220329)
        )
    }
    ...
    test("+ multi-asset partial cancel token") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          ExUnits(memory = 152147, steps = 36_160219)
        )
    }
    ...
    test("+ multi-asset partial cancel lovelace") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          ExUnits(memory = 148354, steps = 35_076622)
        )
    }
    ...
    test("* token by 2") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 16842, steps = 3_842024)
        )
    }
    ...
    test("* token by 0") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value.zero,
          ExUnits(memory = 3000, steps = 464100)
        )
    }
    ...
    test("getLovelace zero") {
        assertEvalWithBudget(
          ...
          Value.zero,
          BigInt(0),
          ExUnits(memory = 5796, steps = 1_087206)
        )
    }
    ...
    test("getLovelace lovelace") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          BigInt(1000),
          ExUnits(memory = 20940, steps = 4_787706)
        )
    }
    ...
    test("getLovelace token returns zero") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          BigInt(0),
          ExUnits(memory = 9625, steps = 1_915046)
        )
    }
    ...
    test("quantityOf missing token in lovelace") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          BigInt(0),
          ExUnits(memory = 11026, steps = 2_167876)
        )
    }
    ...
    test("quantityOf matching token") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          BigInt(1000),
          ExUnits(memory = 20940, steps = 4_787855)
        )
    }
    ...
    test("flatten lovelace") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 26580, steps = 6_546443)
        )
    }
    ...
    test("flatten multi-asset") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 47396, steps = 12_146230)
        )
    }
    ...
    test("Eq vs toData: lovelace equal via Eq") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          true,
          ExUnits(memory = 1801, steps = 1_797665)
        )
    }
    ...
    test("Eq vs toData: single token equal via Eq") {
        assertEvalWithBudget(
          ...
          true,
          ExUnits(memory = 1801, steps = 1_879502)
        )
    }
    ...
    test("Eq vs toData: two policies equal via Eq") {
        assertEvalWithBudget(
          ...
          true,
          ExUnits(memory = 106468, steps = 28_182323)
        )
    }
    ...
    test("Eq vs toData: two policies equal via toData") {
        assertEvalWithBudget(
          ...
          true,
          ExUnits(memory = 105568, steps = 28_038323)
        )
    }
    ...
    test("Eq vs toData: three policies equal via toData") {
        assertEvalWithBudget(
          ...
          true,
          ExUnits(memory = 178753, steps = 47_624732)
        )
    }
    ...
    test("Eq vs toData: single token not equal via Eq") {
        assertEvalWithBudget(
          ...
          true,
          ExUnits(memory = 2001, steps = 1_911502)
        )
    }
