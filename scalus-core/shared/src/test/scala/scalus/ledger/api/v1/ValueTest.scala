...
class ValueTest extends AnyFunSuite with EvalTestKit with ArbitraryInstances {
    ...
    test("fromStrictlyAscendingListWithNonZeroAmounts two policies") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 66311, steps = 16_342321)
        )
    }
    ...
    test("unary_ token") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value(utf8"PolicyId", utf8"TokenName", -1000),
          ExUnits(memory = 17142, steps = 3_900279)
        )
    }
    ...
    test("+ token + token") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 65991, steps = 15_823119)
        )
    }
    ...
    test("+ token + zero") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          ExUnits(memory = 49346, steps = 11_637367)
        )
    }
    ...
    test("+ zero + token") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          ExUnits(memory = 48546, steps = 11_509367)
        )
    }
    ...
    test("+ lovelace + lovelace") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          Value.lovelace(3000),
          ExUnits(memory = 65991, steps = 15_822970)
        )
    }
    ...
    test("+ token + lovelace") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 89330, steps = 21_954940)
        )
    }
    ...
    test("+ token cancel") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value.zero,
          ExUnits(memory = 49307, steps = 11_010848)
        )
    }
    ...
    test("+ lovelace cancel") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          Value.zero,
          ExUnits(memory = 49307, steps = 11_010699)
        )
    }
    ...
    test("+ multi-asset cancel") {
        assertEvalWithBudget(
          ...
          Value.zero,
          ExUnits(memory = 199641, steps = 47_572329)
        )
    }
    ...
    test("+ multi-asset partial cancel token") {
        assertEvalWithBudget(
          ...
          Value.lovelace(1000),
          ExUnits(memory = 153647, steps = 36_400219)
        )
    }
    ...
    test("+ multi-asset partial cancel lovelace") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          ExUnits(memory = 149454, steps = 35_252622)
        )
    }
    ...
    test("* token by 2") {
        assertEvalWithBudget(
          ...
          ExUnits(memory = 17342, steps = 3_922024)
        )
    }
    ...
    test("* token by 0") {
        assertEvalWithBudget(
          ...
          Value(utf8"PolicyId", utf8"TokenName", 1000),
          Value.zero,
          ExUnits(memory = 2100, steps = 320100)
        )
    }
    ...
    test("Eq vs toData: two policies equal via Eq") {
        assertEvalWithBudget(
          ...
          true,
          ExUnits(memory = 104168, steps = 27_814323)
        )
    }
    ...
    test("Eq vs toData: three policies equal via toData") {
        assertEvalWithBudget(
          ...
          true,
          ExUnits(memory = 176653, steps = 47_288732)
        )
    }
