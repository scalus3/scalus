...
lazy val scalus = crossProject(JSPlatform, JVMPlatform, NativePlatform)
    ...
    .settings(
      ...
      libraryDependencies += "com.github.plokhotnyuk.jsoniter-scala" %%% "jsoniter-scala-macros" % "2.38.12" % "compile",
...
lazy val scalusTestkit = crossProject(JSPlatform, JVMPlatform)
    ...
    .jvmSettings(
      ...
      libraryDependencies += "com.softwaremill.sttp.client4" %% "core" % "4.0.24",
      libraryDependencies += "org.slf4j" % "slf4j-simple" % slf4jVersion % Test
    )
    .jsSettings(
      Compile / npmDependencies += "@noble/curves" -> nobleCurvesVersion,
