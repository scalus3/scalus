...
lazy val scalus = crossProject(JSPlatform, JVMPlatform, NativePlatform)
    ...
    .settings(
      ...
      libraryDependencies += "com.github.plokhotnyuk.jsoniter-scala" %%% "jsoniter-scala-core" % "2.38.7",
      libraryDependencies += "com.github.plokhotnyuk.jsoniter-scala" %%% "jsoniter-scala-macros" % "2.38.7" % "compile",
