...
- **[Stake Validator](/docs/learning/design-patterns/stake-validator-pattern)** - Optimize multi-input transactions
- **[Transaction Level Minter](/docs/learning/design-patterns/transaction-level-minter-pattern)** - Couple spending and minting endpoints
