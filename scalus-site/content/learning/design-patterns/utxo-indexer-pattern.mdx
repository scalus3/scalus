...
- **[Stake Validator](/docs/learning/design-patterns/stake-validator-pattern)** - For reducing per-input execution costs
- **[Linked List](/docs/learning/design-patterns/linked-list-pattern)** - For ordered on-chain data structures
