...
**Use [Yaci DevKit](/docs/ledger/yaci-devkit)** when you need the actual Haskell Cardano node for final validation before deployment.
...
- [Yaci DevKit](/docs/ledger/yaci-devkit) — Docker-based devnet for integration testing
