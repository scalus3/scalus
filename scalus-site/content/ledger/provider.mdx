...
description: Interact with the Cardano blockchain using the Provider interface.
---
...
Learn more about the Emulator in the [Emulator documentation](/ledger/emulator).
