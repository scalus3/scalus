...
- **[Learn Smart Contract Development](/docs/smart-contracts/developing-smart-contracts)** - Deep dive into writing Cardano validators with Scala 3, understanding the compilation process, and leveraging the Scalus type system
...
**New to Cardano or Scala?** Check out our onboarding guides:
- **[For Scala Developers](/docs/get-started/for-scala-developers)** — Cardano concepts for Scala developers
- **[For Cardano Developers](/docs/get-started/for-cardano-developers)** — Scala basics for Cardano developers