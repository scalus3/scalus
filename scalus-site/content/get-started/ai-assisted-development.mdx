...
description: Use Claude Code, Cursor, and other LLM coding agents with Scalus – llms.txt context artifacts, AI-ready project templates, and the Scalus Claude Code plugin with task skills.
---
