---
title: Migrating from 0.18 to 1.0
sidebarTitle: Migrating to 1.0
description: What changed between Scalus 0.18.x and 1.0.0-M1 and how to update your project.
---
...
```scala
libraryDependencies += "org.scalus" %% "scalus" % "1.0.0-M1"
addCompilerPlugin("org.scalus" %% "scalus-plugin" % "1.0.0-M1")
```
