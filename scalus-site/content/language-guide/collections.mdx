...
Scalus provides several collection types for organizing and manipulating data in smart contracts. These collections are optimized for blockchain execution and compile efficiently to Plutus Core.
