...
description: Work with collections in Cardano smart contracts using Scalus. Learn List operations, SortedMap and AssocMap key-value maps, and efficient data manipulation for on-chain validators.
---
