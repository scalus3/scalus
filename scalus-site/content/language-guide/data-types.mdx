---
title: Custom Data Types for Cardano Smart Contracts
sidebarTitle: Custom Data Types
description: Define custom data types using Scala case classes and enums for Cardano smart contracts. Learn ToData/FromData, pattern matching, extension methods, and best practices.
---
