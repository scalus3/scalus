...
description: Learn how Scala developers can build Cardano smart contracts using familiar tools and patterns. From first validator to production deployment in hours.
