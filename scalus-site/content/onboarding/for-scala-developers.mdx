...
4. **[Validators in Depth](/docs/smart-contract/validators)** → 20 min
5. **[Supported Features](/docs/language-guide/support)** → 10 min
6. **[Testing Smart Contracts](/docs/smart-contract/testing)** → 20 min
7. **Build your own validator** → 45 min
