...
- [ ] **[Spending UTxOs](/docs/transaction-builder/spending-utxos)** - Spend from validator scripts
- [ ] **[Minting & Burning Assets](/docs/transaction-builder/minting-burning-assets)** - Create and burn native tokens
- [ ] **[Staking & Rewards](/docs/transaction-builder/staking-rewards)** - Register, delegate, and withdraw rewards
- [ ] **[Governance](/docs/transaction-builder/governance)** - Participate in Cardano governance with DReps
