---
title: Boundary Testing for Cardano Smart Contracts
sidebarTitle: Boundary Testing
description: Explore smart contract boundaries with automated transaction variations, attack patterns, and multi-step state-space exploration. Includes ScalaCheck Commands, Scenario exhaustive testing, and standard vulnerability patterns.
---
