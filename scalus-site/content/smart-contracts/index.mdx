...
- **[Blueprint Generation](/docs/smart-contracts/blueprint)** — Generate CIP-57 blueprints with the sbt plugin and verify on-chain script hashes
- **[Deploying Contracts](/docs/smart-contracts/deploy)** — Publish compiled contracts as reference script UTxOs via Blockfrost
