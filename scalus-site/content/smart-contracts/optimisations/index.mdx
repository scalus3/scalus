...
description: Advanced optimization techniques for Cardano smart contracts. Learn to inspect compiled output, apply general and backend-specific optimizations, and build hand-crafted UPLC validators.
---
...
- **[Measuring Performance](/docs/smart-contracts/optimisations/measuring-performance)** -- script evaluation, emulator-based transaction fees
- **[Algorithmic Optimizations](/docs/smart-contracts/optimisations/algorithmic-optimizations)** -- design patterns for the biggest wins
- **[Scala Metaprogramming](/docs/smart-contracts/optimisations/inlining)** -- inlining, loop unrolling, constants, compile-time evaluation, conditional compilation
- **[Direct Builtins Usage](/docs/smart-contracts/optimisations/direct-builtins)** -- manual Data access, script context macros, budget comparison
- **[Backend-Specific Notes](/docs/smart-contracts/optimisations/backend-notes)** -- `@UplcRepr`, V3 Lowering vs template-based backends
- **[UPLC Term DSL](/docs/smart-contracts/optimisations/uplc-term-dsl)** -- hand-craft validators with full AST control (Plutarch-style)
- **[UPLC Optimizer Pipeline](/docs/smart-contracts/optimisations/uplc)** -- apply low-level optimizer passes to reduce execution costs
