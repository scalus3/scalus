---
title: CIP-57 Blueprint Generation and Script Hash Verification in Scalus
sidebarTitle: Blueprint Generation
description: Generate CIP-57 Plutus blueprints with the Scalus sbt plugin, embed them in JARs, and verify Cardano script hashes against on-chain deployed contracts.
---
...
- **[Deploying Contracts](/docs/smart-contracts/deploy)** — Publish the compiled contract as a reference script UTxO via Blockfrost
- **[Working with Contract](/docs/dapp-development/working-with-contract)** — Use the blueprint to drive off-chain code in your dapp
