...
- **[Testing](/docs/smart-contract/testing)** - Write comprehensive tests for your validators
- **[Compiling](/docs/smart-contract/compiling)** - Compile debugged validators to Plutus scripts
- **[Optimisations](/docs/smart-contract/optimisations)** - Optimize script size and execution costs