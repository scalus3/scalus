...
- **Debug** - [Debug validators](/docs/smart-contract/debugging) as regular Scala code with your IDE's debugger
- **Build** - [Construct transactions](/docs/transaction-builder) with the transaction builder and evaluate them off-chain
- **Integrate** - Seamlessly integrate on-chain and off-chain components in your full-stack application
- **Test** - [Test thoroughly](/docs/smart-contract/testing) with unit, integration, and property-based tests
...
<DescriptionCards>
  ...
  <DescriptionCards.Card
    ...
    href="/docs/transaction-builder/building-first-transaction"
    description="Construct and submit Cardano transactions with TxBuilder"
  />
  <DescriptionCards.Card
    icon="💡"
    title="Browse Examples"
    href="https://github.com/nau/scalus/tree/master/scalus-examples"
