...
- **Write** - [Cardano smart contracts in Scala 3](/docs/smart-contracts/developing-smart-contracts) that compile to UPLC
- **Optimize** - Use [advanced optimization techniques](/docs/smart-contracts/optimisations) to reduce on-chain costs
