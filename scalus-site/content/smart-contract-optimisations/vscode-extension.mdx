---
title: Scalus Profiler VS Code Extension
sidebarTitle: VS Code Extension
description: See CEK execution cost on every source line and the compiled UPLC of your validator, right in VS Code.
---
...
{/* TODO: capture and add the UPLC preview screenshot:
![Compiled UPLC view with bidirectional cursor sync](/scalus-uplc-view.png) */}
