---
title: Measuring Cardano Smart Contract Performance
sidebarTitle: Measuring Performance
description: Measure Cardano smart contract cost in Scalus — CPU steps, memory units, flat-encoded script size, and total transaction fee via direct evaluation and the Emulator.
---
