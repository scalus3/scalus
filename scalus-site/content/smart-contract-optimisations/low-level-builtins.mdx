---
title: Low-Level UPLC Builtins and Raw Plutus Data in Scalus
sidebarTitle: Low-Level Builtins
description: Drop below high-level prelude types and write Plutus validators using UPLC builtins and raw Plutus Data directly in Scalus — compiled-assembler control over on-chain code.
---
