...
Extend the [Stake Validator Pattern](/docs/design-patterns/withdraw-zero) to allow spending validators to **read verified data** from the stake validator's redeemer.
