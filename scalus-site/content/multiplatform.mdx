---
title: Multiplatform Support - JVM, JavaScript, Native
sidebarTitle: Multiplatform
description: Scalus runs on JVM, JavaScript (Node.js/browser), and Native platforms. Build Cardano smart contracts and offchain code that compiles to any target from the same Scala 3 codebase.
---
...
Scalus compiles to **JVM**, **JavaScript**, and **Native** from the same Scala 3 codebase. Write once, deploy anywhere — from server-side backends to browser wallets to CLI tools.

## Platform Support Matrix

| Module | JVM | JavaScript | Native | Description |
|--------|:---:|:----------:|:------:|-------------|
...
### JavaScript — Offchain & Browser

JavaScript enables Scalus in Node.js and browser environments:
...
- [Emulator](/docs/ledger/emulator) — In-memory testing (JVM/JS)
- [Transaction Builder](/docs/transaction-builder) — Build transactions (JVM/JS)
- [Yaci DevKit](/docs/ledger/yaci-devkit) — Integration testing (JVM only)
